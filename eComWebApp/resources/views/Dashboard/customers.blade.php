                                ...
                                <tbody>
                                    ...
                                    @foreach($customers as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->fullname }}</td>
                                            <td>
                                                <img src="{{ URL::asset('uploads/profiles/' . $item->picture) }}"
                                            ...
                                            <td>
                                                @if($item->status == 'Active')
                                                    <a href="{{ route('changeUserStatus', ['status' => 'Blocked', 'id' => $item->id]) }}"
                                                        class="btn btn-danger">Block</a>
                                                @else
                                                    <a href="{{ route('changeUserStatus', ['status' => 'Active', 'id' => $item->id]) }}"
